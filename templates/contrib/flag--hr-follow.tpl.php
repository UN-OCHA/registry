 ...
 * applied to the link.
 *
 * - $action: The action the link is about to carry out,
 ...
 *
 * - $message_text: The long message to show after a flag action
 *   has been carried out.
 * - $message_classes: A space-separated list of CSS classes that
 ...
 *   this value will be boolean TRUE. This is usually used in conjunction
 *   with immedate JavaScript-based toggling of flags.
 ...
 *
 * NOTE: This template spaces out the <span> tags for clarity only. When
 * doing some advanced theming you may have to remove all the whitespace.
 */
?>
